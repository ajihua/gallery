...
<div class="header">
  ...
  <div class="menu"   onclick="show_menu()" onmouseleave="show_menu1()">
    ...
    <ul id="title">
      <li><a href="/gallery/page?c=1">现实主义</a></li>
      <li><a href="/gallery/page?c=2">抽象主义</a></li>
    </ul>
  </div>
  <div class="auth">
    <ul>
...
<div class="content">
  ...
  <div class="img-content">
    <ul>
      ...
      <li>
        <img src="/gallery/${painting.preview}" class="img-li">
        <div class="info">
  ...
  <div class="page-nav">
    <ul>
      <li><a href="/gallery/page?p=1${categoryParam}">首页</a></li>
      <li><a href="/gallery/page?p=${pageModel.hasPreviousPage?pageModel.page-1:1}${categoryParam}">上一页</a></li>
      <c:forEach begin="1" end="${pageModel.totalPages}" var="pno">
        <li><span ${pno==pageModel.page?"class='first-page'":""}>
          <a href="/gallery/page?p=${pno}${categoryParam}">${pno}</a>
        </span></li>
      </c:forEach>
      <li><a href="/gallery/page?p=${pageModel.hasNextPage?pageModel.page+1:pageModel.totalPages}${categoryParam}">下一页</a></li>
      <li><a href="/gallery/page?p=${pageModel.totalPages}${categoryParam}">尾页</a></li>
    </ul>
  </div>
</div>
<div class="footer">
  <p><span>M-GALLARY</span>©2022 POWERED BY IMOOC.INC</p>
</div>
</body>
</html>
